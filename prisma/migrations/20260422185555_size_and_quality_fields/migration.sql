...
INSERT INTO "new_CompressionRun" ("bppEstimate", "compressionRatio", "createdAt", "dctPreviewPath", "id", "mse", "originalFilename", "originalImagePath", "pipelineMode", "psnr", "quality", "quantPreviewPath", "quantizationLabel", "reconstructedImagePath", "retainedCoefficients", "sparsity", "threshold", "transformType") SELECT "bppEstimate", "compressionRatio", "createdAt", "dctPreviewPath", "id", "mse", "originalFilename", "originalImagePath", "pipelineMode", "psnr", "quality", "quantPreviewPath", "quantizationLabel", "reconstructedImagePath", "retainedCoefficients", "sparsity", "threshold", "transformType" FROM "CompressionRun";
